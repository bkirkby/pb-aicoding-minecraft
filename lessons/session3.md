...
Reading the code for real: the AI walks through the quest giver line by line while you follow in IntelliJ. And breaking things on purpose, so you learn how to get back to the last commit when something goes wrong.
