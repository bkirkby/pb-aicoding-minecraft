...
- **A mod that installs its own model**: it checks the computer, downloads what's missing with progress shown in-game, and starts and stops the model server with the game.
...
| [Phi-3.5 mini Instruct](https://huggingface.co/bartowski/Phi-3.5-mini-instruct-GGUF), Q4_K_M GGUF | The pet's brain, about 2.4 GB, downloaded by the mod |
